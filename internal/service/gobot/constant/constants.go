...
const Start = "Hello, press command button to start"
...
Send the command /list-categories and reply with the number of any category. For example, to list all the packages for the "Actual Middlewares" category, you would reply with 0.
