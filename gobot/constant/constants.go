...
Send the command /list_categories and reply with the number of any category. For example, to list all the packages for the "Actual Middlewares" category, you would reply with 0.
